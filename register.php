...
<head>
    ...
    <title>تسجيل جديد - بنك العائلة</title>
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="bg-blue-800 py-4 px-6">
                <h2 class="text-2xl font-bold text-white text-center">تسجيل حساب جديد</h2>
            </div>
            <form class="p-6" action="process_register.php" method="POST">
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="name" name="name" class="w-full pr-10 pl-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="أدخل اسمك" required>
                    </div>
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="confirm_password" class="block text-gray-700 font-medium mb-2">تأكيد كلمة المرور</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <i data-feather="lock" class="text-gray-400"></i>
                        </div>
                        <input type="password" id="confirm_password" name="confirm_password" class="w-full pr-10 pl-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="********" required>
                    </div>
                </div>
                <div class="mb-6">
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="mr-2 text-sm text-gray-600">أوافق على <a href="#" class="text-blue-600 hover:underline">الشروط والأحكام</a></label>
                    </div>
                </div>
                ...
                <div class="mt-4 text-center">
                    ...
                    <a href="login.php" class="text-blue-600 hover:underline font-medium">سجل دخولك</a>
                </div>
            </form>
        </div>
    </div>
